  ...
  return (
    <div className="w-full bg-primaryBg rounded-xl flex justify-between items-center p-6">
      <div className="flex flex-col">
        <div className="text-lg text-fontLight font-bold font-oneset">
          Min Vikings +3.5
        </div>
      ...
      <div className="text-fontLight font-oneset text-xs font-thin mt-6">Date/Time Placed</div>
      </div>
      <div
        className={`${resultBg[result]} px-2 text-fontLight font-bold rounded`}
      >
        {result}
      </div>
    </div>
